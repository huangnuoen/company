...
function setAllTextLanguage(which){
    ...
    var tutorial = {
        common: {
            ...
            room1: 'Living Room',
            room2: 'Bedroom',
            room3: 'Other Triggers',
            device1: 'Air Condition',
            device2: 'Lamp',
            device3: 'Plug X',
            device4: 'Ceiling Lights',
            device5: 'Television',
            device6: 'Dock',
            device7: 'Air Condition',
        ...
        scene: {
            ...
            revert:'reset',
            desktop: 'Desktop',
            follow: 'Do the following!',
            room1: 'Living Room',
            room2: 'Bedroom',
            device2: 'Lamp',
            device4: 'Ceiling Lights',
            rout: ['Solid','Rainbow', 'Pattern', 'Random'],
            presets: 'Presets',
            myColor: 'My Saved Colors',
            on: 'on',
            off: 'off',
        }
    };
    switch(which){
        ...
        case 'tutorial':        return tutorial;         break;
    }
}