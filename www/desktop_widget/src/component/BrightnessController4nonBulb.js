...
define(['Vue','util/popupTools','jquery_touchy'],
    function(Vue,popupTools,jquery_touchy) {
        var obj = {};
        obj.run = function(nodeID,value,operateID,bus){
            var thisComponent = {};
                ...
                syncSend(function () {
                    ...
                    if($('#onOffButtonSVGPath').attr('class') === 'powerOff'){
                        ...
                        if(toSendBrightness<1){
                            ...
                            cordova.exec(null,null,"FTP2PApi","deviceControl",[nodeID,"mlevel01",toSendBrightness+'',"mtLevel"]);
                        }
                        setTimeout(function () {
            ...
            function renderPosition(x){
                x = typeof x === "number" ?(x<=0 || isNaN(x) === true ?1:x):1;
