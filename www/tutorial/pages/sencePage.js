...
window.onload = function () {
    ...
    Vue.component('page1', {
        ...
        mounted:function(){
			...
			tutorialCommon.blackBoxAnimation(6, -6, 6, -1);
    ...
    Vue.component('page2', {
        ...
        mounted:function(){
			...
			tutorialCommon.blackBoxAnimation(6, -6, -6, 6);
            tutorialCommon.clickAnimation();
        },
        methods:{
            go:function() {
    ...
    Vue.component('page5', {
        ...
        mounted:function(){
            ...
            tutorialCommon.blackBoxAnimation(6, -6, -6, 6);
            tutorialCommon.clickAnimation('.mycircle1');
            tutorialCommon.clickAnimation();
        ...
        methods:{
            ...
            goP5: function () {
                ...
                this.$nextTick(function () {
                    tutorialCommon.blackBoxAnimation(6, -6, -6, 6);
                    // tutorialCommon.clickAnimation();
                    TweenLite.to(brightnessPointer, 0.45, {attr:{cx:'304',ease:Linear.easeNone}});
                })
            },
            goP6:function() {
                this.p5 = false;
                ...
                tutorialCommon.scrollToTop('0', '-185');
            ...
            goP7: function () {
                ...
                tutorialCommon.scrollToTop('-190', '-320');
            ...
            backP4: function () {
                ...
                TweenLite.set(brightnessPointer, {attr:{cx:'54'}});
            },
            backP5: function () {
                this.p5 = true;
                this.p6 = false;
    ...
    Vue.component('page8', {
        ...
        methods:{
            ...
            backP7: function () {
                ...
                //     console.log('kljl');
                //     $('.promptBoxUp').removeClass('promptBoxNone');
                // })
            }
        }
    });
